...
<body>
    ...
    <div class="judul-surat">
        <h2>KEPUTUSAN KEPALA MADRASAH MI DAARUL HIKMAH</h2>
        <p>NOMOR : {{ $sk->nomor_sk }}</p>

        <p class="tentang">TENTANG</p>
        <p><strong>PENETAPAN TUGAS TAMBAHAN</strong></p>
            ...
            <td>
                <ol start="3">
                    ...
                    <li>Bahwa yang namanya tercantum pada surat keputusan ini dipandang cakap dan mampu melaksanakan
                        kegiatan belajar mengajar dan tertib administradi di MI Daarul Hikmah</li>
                </ol>
            </td>
        </tr>
    </table>
        ...
        <tr>
            ...
            <td>
                <ol start="3">
                    ...
                    <li>Keputusan musyawarah pengurus yayasan tanggal 02 Juli 2025;</li>
                </ol>
            </td>
        </tr>
    </table>
                ...
                <div class="data-guru">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td><strong>{{ strtoupper($sk->tugas_tambahan) }}</strong></td>
                        </tr>
                    </table>
                </div>
            </td>
