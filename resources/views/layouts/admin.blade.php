                ...
                <nav class="flex-1 px-3 py-4 space-y-1.5 overflow-y-auto">
                    ...
                    @php
                        $suratPernyataanActive =
                            ...
                            request()->routeIs('surat-pernyataan-rombel.*') ||
                    ...
                    <div x-data="{ open: {{ $suratPernyataanActive ? 'true' : 'false' }} }" class="space-y-0.5">
                        ...
                        <div x-show="open && !sidebarCollapsed" x-collapse x-cloak class="pl-4 space-y-0.5">
                            ...
                            <a href="{{ route('surat-pernyataan-rombel.index') }}"
                                class="sidebar-item flex items-center gap-3 px-3 py-2 rounded-xl text-sm {{ request()->routeIs('surat-pernyataan-rombel.*') ? 'bg-gray-900 text-white nav-active' : 'text-gray-500 hover:bg-gray-100 hover:text-gray-900' }}"
                                wire:navigate>
                                <div
                                    class="w-1.5 h-1.5 rounded-full flex-shrink-0 {{ request()->routeIs('surat-pernyataan-rombel.*') ? 'bg-white' : 'bg-gray-300' }}">
                                </div>
                                <span class="whitespace-nowrap">Surat Pernyataan Rombel</span>
                            </a>
                        </div>
                    </div>
                    ...
                    <a href="{{ route('licenses.index') }}"
                        ...
                        :class="{ 'justify-center px-0': sidebarCollapsed }" wire:navigate title="Lisensi">
                        <div
                            class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 {{ request()->routeIs('licenses.*') ? 'bg-white/20' : 'bg-gray-100' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('users.index') }}"
                        ...
                        :class="{ 'justify-center px-0': sidebarCollapsed }" wire:navigate title="Manajemen User">
                        <div
                            class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 {{ request()->routeIs('users.*') ? 'bg-white/20' : 'bg-gray-100' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <span x-show="!sidebarCollapsed" x-transition.opacity.duration.300ms
                            class="whitespace-nowrap">Manajemen User</span>
                    </a>
