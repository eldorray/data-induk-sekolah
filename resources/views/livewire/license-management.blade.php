                                    ...
                                    <td class="px-6 py-4">
                                        @if ($license->domain)
                                            <div class="flex items-center gap-1.5">
                                                ...
                                                <button wire:click="resetDomain({{ $license->id }})"
                                                    wire:confirm="Reset domain binding? License bisa diaktivasi ulang di domain lain."
                                                    class="p-1 rounded-md hover:bg-blue-50 text-gray-400 hover:text-blue-600 transition-colors"
                                                    title="Reset Domain">
