...
class SkTugasTambahanMiManagement extends Component
{
    ...
    public function save(): void
    {
        ...
        if ($this->isEditing) {
            ...
            $sk->update($validated);
            session()->flash('success', 'SK Tugas Tambahan berhasil diperbarui.');
        } else {
            SkTugasTambahanMi::create($validated);
            session()->flash('success', 'SK Tugas Tambahan berhasil ditambahkan.');
        }
    ...
    public function delete(): void
    {
        ...
        $this->skId = null;
        session()->flash('success', 'SK Tugas Tambahan berhasil dihapus.');
    }
    ...
    /**
     * Get list of common tugas tambahan options
     */
    public static function getTugasTambahanOptions(): array
    {
        return [
            'Kepala Perpustakaan',
            'Kepala Laboratorium',
    ...
    public function render()
    {
        ...
        return view('livewire.sk-tugas-tambahan-mi-management', [
            'skList' => $skList,
            'tugasTambahanOptions' => self::getTugasTambahanOptions(),
        ])->layout('layouts.admin', ['header' => 'SK Tugas Tambahan MI']);
    }
}
