...
class SkTugasTambahanMiBulkDownloadTest extends TestCase
{
    use RefreshDatabase;

    public function test_selected_aktif_sk_are_downloaded_as_one_file(): void
    {
        $first = $this->createSk(['nomor_sk' => '0001/SK/TT/I/2026']);
        $second = $this->createSk([
            'nomor_sk' => '0002/SK/TT/I/2026',
        ...
        Livewire::test(SkTugasTambahanMiManagement::class)
    ...
    public function test_non_aktif_sk_are_skipped_and_an_empty_selection_is_rejected(): void
    {
        ...
        Livewire::test(SkTugasTambahanMiManagement::class)
            ...
            ->assertSee('Pilih minimal satu SK Tugas Tambahan berstatus aktif untuk diunduh.');
    }

    public function test_toggle_select_page_only_picks_aktif_rows_and_toggles_back_off(): void
    {
        $aktif = $this->createSk(['nomor_sk' => '0001/SK/TT/I/2026']);
        $this->createSk([
            'nomor_sk' => '0002/SK/TT/I/2026',
            'status' => 'draft',
            'guru_mi_id' => $this->createGuru([
    ...
    public function test_pdf_view_renders_one_document_per_sk_separated_by_page_breaks(): void
    {
        ...
        $html = view('pdf.sk-tugas-tambahan-mi', [
            'skList' => SkTugasTambahanMi::with('guru')->orderBy('nomor_sk')->get(),
    ...
    private function createSk(array $overrides = []): SkTugasTambahanMi
    {
        $guruId = $overrides['guru_mi_id'] ?? $this->createGuru()->id;
        unset($overrides['guru_mi_id']);

        return SkTugasTambahanMi::create(array_merge([
            'guru_mi_id' => $guruId,
            'nomor_sk' => '0001/SK/TT/I/2026',
            ...
            'penandatangan_nama' => 'Kepala Madrasah',
            'penandatangan_jabatan' => 'Kepala Madrasah',
